...
@pytest.fixture
def project(db):
    return Project.objects.create(name="pagination-test-project")
...
class TestSaasApiPagination:
    """通过 webhook-events 端点验证全局分页实际生效。"""

    endpoint_template = "/saas/v1/projects/{appid}/webhook-events"
